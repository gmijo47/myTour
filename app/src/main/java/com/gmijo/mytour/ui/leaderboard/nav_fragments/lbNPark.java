...
public class lbNPark extends Fragment implements navInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lb_npark, container, false);
        recyclerView =  (RecyclerView)  view.findViewById(R.id.nParkRecView);
        loader = (ConstraintLayout) view.findViewById(R.id.loaderNPark);
        titleNPark = (TextView) view.findViewById(R.id.titleNPark);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Boolean dataExists = dataHelper.checkTableDatExt(TAB_NPARK_STATS);
        ...
        if (!dataExists){
            ...
            //Query komanda
            Query query = usersRef.orderBy("achievementData.nationalParkExplored", Query.Direction.DESCENDING).limit(15);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            try {
                                ...
                                dataHelper.insertData(TAB_NPARK_STATS, COL_USERNAME, COL_COUNT, document.get("personalData.Username").toString(), document.get("achievementData.nationalParkExplored").toString(), true);
    ...
    public void displayData() {
        ...
        List<Pair<String, String>> data = dataHelper.obtainData(TAB_NPARK_STATS);
        ...
        titleNPark.setVisibility(View.VISIBLE);
