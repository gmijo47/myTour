...
public class lbNPoint extends Fragment implements navInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lb_n_point, container, false);
        recyclerView =  (RecyclerView)  view.findViewById(R.id.nPointRecView);
        loader = (ConstraintLayout) view.findViewById(R.id.loaderNPoint);
        titleNPoint = (TextView) view.findViewById(R.id.titleNPoint);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Boolean dataExists = dataHelper.checkTableDatExt(TAB_NPOINT_STATS);
        ...
        if (!dataExists){
            ...
            //Query komanda
            Query query = usersRef.orderBy("achievementData.naturepointExplored", Query.Direction.DESCENDING).limit(15);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            try {
                                ...
                                dataHelper.insertData(TAB_NPOINT_STATS, COL_USERNAME, COL_COUNT, document.get("personalData.Username").toString(), document.get("achievementData.naturepointExplored").toString(), true);
    ...
    public void displayData() {
        ...
        List<Pair<String, String>> data = dataHelper.obtainData(TAB_NPOINT_STATS);
        ...
        titleNPoint.setVisibility(View.VISIBLE);
