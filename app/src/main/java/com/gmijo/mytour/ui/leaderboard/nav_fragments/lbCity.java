...
public class lbCity extends Fragment implements navInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_lb_city, container, false);
        recyclerView =  (RecyclerView)  view.findViewById(R.id.cityRecView);
        loader = (ConstraintLayout) view.findViewById(R.id.loaderCity);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Boolean dataExists = dataHelper.checkTableDatExt(TAB_CITY_STATS);
        ...
        if (!dataExists){
            ...
            //Query komanda
            Query query = usersRef.orderBy("achievementData.cityExplored", Query.Direction.DESCENDING).limit(15);
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            try {
                                ...
                                dataHelper.insertData(TAB_CITY_STATS, COL_USERNAME, COL_COUNT, document.get("personalData.Username").toString(), document.get("achievementData.cityExplored").toString(), true);
    ...
    public void displayData() {
        ...
        List<Pair<String, String>> data = dataHelper.obtainData(TAB_CITY_STATS);
